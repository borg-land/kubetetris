...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    _createUI: function() {
      ...
      backgroundaudio.src = "backgroundaudio.ogg";
...
window.BlockrainThemes = {
  'custom': {
    ...
    complexBlocks: {
      line:     ['assets/blocks/custom/line_sb.png', 'assets/blocks/custom/line_sb.png'],
      square:   ['assets/blocks/custom/square_sb.png'],
      arrow:    'assets/blocks/custom/arrow_sb.png',
      rightHook:['assets/blocks/custom/rightHook_sb.png'],
      leftHook: 'assets/blocks/custom/leftHook_sb.png',
      rightZag: ['assets/blocks/custom/rightZag_sb.png'],
      leftZag:  'assets/blocks/custom/leftZag_sb.png'
    }
  }
};